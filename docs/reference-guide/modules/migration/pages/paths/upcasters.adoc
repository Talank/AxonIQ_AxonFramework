...
In Axon Framework 4 you registered upcasters with an `EventUpcasterChain`; in Axon Framework 5 you register transformations with an `EventTransformerChain`.
